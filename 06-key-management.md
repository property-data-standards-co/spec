...
| `federation-service@pdtf-platform-prod.iam` | pdtf-platform-prod | `cloudkms.cryptoKeyVersions.useToSign` | `moverly-platform-signing-key` (signs federation Entity Statements + Trust Marks + platform status lists) |
